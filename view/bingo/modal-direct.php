<div class="modal fade" id="modal-bingo" data-backdrop="static">
                ...
                <div class="row col-lg-12 text-center mt-4">
                        ...
                        <div class="p-4 m-4" style="background-color: #32D582; border-radius: 15px; border: 3px solid">
                            ...
                            <div class="row mt-4 text-bold" style="font-size: 18px">
                                <div class="col">
                                    ...
                                    <?php for ($i = 1; $i <= 18; $i++) { ?>
                                        <div id="num_<?php echo $i; ?>"><?php echo $i; ?></div>
                                    <?php } ?>
                                </div>
                                <div class="col">
                    ...
                    <div class="col-lg-4">
                        <div class="pl-5 pr-5 mt-2">
                            <div class="card">
                                <p style="font-size: 100px;" id="random-number">00</p>
                            </div>
                        </div>
                        <div class="mt-2">
