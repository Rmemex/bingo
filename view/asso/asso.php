<div class="row mt-4" id="assoc-page">
    ...
    <div class="col-7 col-sm-9">
        <div class="tab-content" id="vert-tabs-tabContent">
            ...
            <div class="tab-pane fade fontWhite" id="vert-tabs-ticket" role="tabpanel" aria-labelledby="vert-tabs-ticket-tab">
                <?php
            ...
            <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab" style="height: 70vh;">
                <?php
